# 22-privacy-data-protection-us-state — Codex Agent
...
cp 22-privacy-data-protection-us-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 22-privacy-data-protection-us-state.md
# OR
...
```bash
rm .codex/agents/22-privacy-data-protection-us-state.md
# OR
rm .codex/agents/22-privacy-data-protection-us-state.md
```
