# 16-new-client-matter-intake — Codex Agent
...
cp 16-new-client-matter-intake.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 16-new-client-matter-intake.md
# OR
...
```bash
rm .codex/agents/16-new-client-matter-intake.md
# OR
rm .codex/agents/16-new-client-matter-intake.md
```
