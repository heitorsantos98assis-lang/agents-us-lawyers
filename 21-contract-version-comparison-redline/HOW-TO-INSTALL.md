# 21-contract-version-comparison-redline — Codex Agent
...
cp 21-contract-version-comparison-redline.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 21-contract-version-comparison-redline.md
# OR
...
```bash
rm .codex/agents/21-contract-version-comparison-redline.md
# OR
rm .codex/agents/21-contract-version-comparison-redline.md
```
