# 36-child-spousal-support-action — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `36-child-spousal-support-action.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 36-child-spousal-support-action.zip
```
...
cp 36-child-spousal-support-action.md .claude/agents/
...
```
Use the child-spousal-support-action subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 36-child-spousal-support-action.md
# OR
...
```bash
rm .claude/agents/36-child-spousal-support-action.md
# OR
rm ~/.claude/agents/36-child-spousal-support-action.md
```
