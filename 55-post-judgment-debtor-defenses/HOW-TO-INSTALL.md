# 55-post-judgment-debtor-defenses — Codex Agent
...
cp 55-post-judgment-debtor-defenses.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 55-post-judgment-debtor-defenses.md
# OR
...
```bash
rm .codex/agents/55-post-judgment-debtor-defenses.md
# OR
rm .codex/agents/55-post-judgment-debtor-defenses.md
```
