# 54-judgment-enforcement-collection — Codex Agent
...
cp 54-judgment-enforcement-collection.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 54-judgment-enforcement-collection.md
# OR
...
```bash
rm .codex/agents/54-judgment-enforcement-collection.md
# OR
rm .codex/agents/54-judgment-enforcement-collection.md
```
