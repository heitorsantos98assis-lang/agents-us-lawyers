# 55-post-judgment-debtor-defenses — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `55-post-judgment-debtor-defenses.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 55-post-judgment-debtor-defenses.zip
```
...
cp 55-post-judgment-debtor-defenses.md .claude/agents/
...
```
Use the post-judgment-debtor-defenses subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 55-post-judgment-debtor-defenses.md
# OR
...
```bash
rm .claude/agents/55-post-judgment-debtor-defenses.md
# OR
rm ~/.claude/agents/55-post-judgment-debtor-defenses.md
```
