# 29-interlocutory-appeal-writ-mandamus — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `29-interlocutory-appeal-writ-mandamus.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 29-interlocutory-appeal-writ-mandamus.zip
```
...
cp 29-interlocutory-appeal-writ-mandamus.md .claude/agents/
...
```
Use the interlocutory-appeal-writ-mandamus subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 29-interlocutory-appeal-writ-mandamus.md
# OR
...
```bash
rm .claude/agents/29-interlocutory-appeal-writ-mandamus.md
# OR
rm ~/.claude/agents/29-interlocutory-appeal-writ-mandamus.md
```
