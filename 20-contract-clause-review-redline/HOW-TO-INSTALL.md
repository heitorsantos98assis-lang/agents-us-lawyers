# 20-contract-clause-review-redline — Codex Agent
...
cp 20-contract-clause-review-redline.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 20-contract-clause-review-redline.md
# OR
...
```bash
rm .codex/agents/20-contract-clause-review-redline.md
# OR
rm .codex/agents/20-contract-clause-review-redline.md
```
