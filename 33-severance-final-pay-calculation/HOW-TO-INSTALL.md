# 33-severance-final-pay-calculation — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `33-severance-final-pay-calculation.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 33-severance-final-pay-calculation.zip
```
...
cp 33-severance-final-pay-calculation.md .claude/agents/
...
```
Use the severance-final-pay-calculation subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 33-severance-final-pay-calculation.md
# OR
...
```bash
rm .claude/agents/33-severance-final-pay-calculation.md
# OR
rm ~/.claude/agents/33-severance-final-pay-calculation.md
```
