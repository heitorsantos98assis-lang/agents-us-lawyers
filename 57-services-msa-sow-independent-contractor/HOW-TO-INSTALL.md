# 57-services-msa-sow-independent-contractor — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `57-services-msa-sow-independent-contractor.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 57-services-msa-sow-independent-contractor.zip
```
...
cp 57-services-msa-sow-independent-contractor.md .claude/agents/
...
```
Use the services-msa-sow-independent-contractor subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 57-services-msa-sow-independent-contractor.md
# OR
...
```bash
rm .claude/agents/57-services-msa-sow-independent-contractor.md
# OR
rm ~/.claude/agents/57-services-msa-sow-independent-contractor.md
```
