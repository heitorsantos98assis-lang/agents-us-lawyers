# 03-matter-status-pacer-state-courts — Codex Agent
...
cp 03-matter-status-pacer-state-courts.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 03-matter-status-pacer-state-courts.md
# OR
...
```bash
rm .codex/agents/03-matter-status-pacer-state-courts.md
# OR
rm .codex/agents/03-matter-status-pacer-state-courts.md
```
