# 19-client-communication-cadence — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `19-client-communication-cadence.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 19-client-communication-cadence.zip
```
...
cp 19-client-communication-cadence.md .claude/agents/
...
```
Use the client-communication-cadence subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 19-client-communication-cadence.md
# OR
...
```bash
rm .claude/agents/19-client-communication-cadence.md
# OR
rm ~/.claude/agents/19-client-communication-cadence.md
```
