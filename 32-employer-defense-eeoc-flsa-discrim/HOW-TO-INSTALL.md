# 32-employer-defense-eeoc-flsa-discrim — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `32-employer-defense-eeoc-flsa-discrim.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 32-employer-defense-eeoc-flsa-discrim.zip
```
...
cp 32-employer-defense-eeoc-flsa-discrim.md .claude/agents/
...
```
Use the employer-defense-eeoc-flsa-discrim subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 32-employer-defense-eeoc-flsa-discrim.md
# OR
...
```bash
rm .claude/agents/32-employer-defense-eeoc-flsa-discrim.md
# OR
rm ~/.claude/agents/32-employer-defense-eeoc-flsa-discrim.md
```
