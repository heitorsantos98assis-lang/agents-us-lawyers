# 04-notice-and-service-response — Codex Agent
...
cp 04-notice-and-service-response.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 04-notice-and-service-response.md
# OR
...
```bash
rm .codex/agents/04-notice-and-service-response.md
# OR
rm .codex/agents/04-notice-and-service-response.md
```
