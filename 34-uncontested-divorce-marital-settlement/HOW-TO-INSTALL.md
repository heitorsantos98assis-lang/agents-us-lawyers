# 34-uncontested-divorce-marital-settlement — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `34-uncontested-divorce-marital-settlement.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 34-uncontested-divorce-marital-settlement.zip
```
...
cp 34-uncontested-divorce-marital-settlement.md .claude/agents/
...
```
Use the uncontested-divorce-marital-settlement subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 34-uncontested-divorce-marital-settlement.md
# OR
...
```bash
rm .claude/agents/34-uncontested-divorce-marital-settlement.md
# OR
rm ~/.claude/agents/34-uncontested-divorce-marital-settlement.md
```
