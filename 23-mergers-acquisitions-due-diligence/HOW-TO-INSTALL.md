# 23-mergers-acquisitions-due-diligence — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `23-mergers-acquisitions-due-diligence.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 23-mergers-acquisitions-due-diligence.zip
```
...
cp 23-mergers-acquisitions-due-diligence.md .claude/agents/
...
```
Use the mergers-acquisitions-due-diligence subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 23-mergers-acquisitions-due-diligence.md
# OR
...
```bash
rm .claude/agents/23-mergers-acquisitions-due-diligence.md
# OR
rm ~/.claude/agents/23-mergers-acquisitions-due-diligence.md
```
