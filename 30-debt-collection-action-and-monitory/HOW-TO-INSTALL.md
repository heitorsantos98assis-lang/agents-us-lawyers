# 30-debt-collection-action-and-monitory — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `30-debt-collection-action-and-monitory.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 30-debt-collection-action-and-monitory.zip
```
...
cp 30-debt-collection-action-and-monitory.md .claude/agents/
...
```
Use the debt-collection-action-and-monitory subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 30-debt-collection-action-and-monitory.md
# OR
...
```bash
rm .claude/agents/30-debt-collection-action-and-monitory.md
# OR
rm ~/.claude/agents/30-debt-collection-action-and-monitory.md
```
