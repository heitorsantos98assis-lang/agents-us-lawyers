# 11-scotus-circuit-research — Codex Agent
...
cp 11-scotus-circuit-research.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 11-scotus-circuit-research.md
# OR
...
```bash
rm .codex/agents/11-scotus-circuit-research.md
# OR
rm .codex/agents/11-scotus-circuit-research.md
```
