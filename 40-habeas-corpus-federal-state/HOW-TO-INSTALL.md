# 40-habeas-corpus-federal-state — Codex Agent
...
cp 40-habeas-corpus-federal-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 40-habeas-corpus-federal-state.md
# OR
...
```bash
rm .codex/agents/40-habeas-corpus-federal-state.md
# OR
rm .codex/agents/40-habeas-corpus-federal-state.md
```
