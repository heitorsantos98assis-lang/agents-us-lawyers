# 20-contract-clause-review-redline — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `20-contract-clause-review-redline.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 20-contract-clause-review-redline.zip
```
...
cp 20-contract-clause-review-redline.md .claude/agents/
...
```
Use the contract-clause-review-redline subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 20-contract-clause-review-redline.md
# OR
...
```bash
rm .claude/agents/20-contract-clause-review-redline.md
# OR
rm ~/.claude/agents/20-contract-clause-review-redline.md
```
