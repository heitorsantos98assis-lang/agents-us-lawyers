# 04-notice-and-service-response — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `04-notice-and-service-response.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 04-notice-and-service-response.zip
```
...
cp 04-notice-and-service-response.md .claude/agents/
...
```
Use the notice-and-service-response subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 04-notice-and-service-response.md
# OR
...
```bash
rm .claude/agents/04-notice-and-service-response.md
# OR
rm ~/.claude/agents/04-notice-and-service-response.md
```
