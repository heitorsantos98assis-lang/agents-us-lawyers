# 42-tax-collection-defense-cdp — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `42-tax-collection-defense-cdp.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 42-tax-collection-defense-cdp.zip
```
...
cp 42-tax-collection-defense-cdp.md .claude/agents/
...
```
Use the tax-collection-defense-cdp subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 42-tax-collection-defense-cdp.md
# OR
...
```bash
rm .claude/agents/42-tax-collection-defense-cdp.md
# OR
rm ~/.claude/agents/42-tax-collection-defense-cdp.md
```
