# 32-employer-defense-eeoc-flsa-discrim — Codex Agent
...
cp 32-employer-defense-eeoc-flsa-discrim.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 32-employer-defense-eeoc-flsa-discrim.md
# OR
...
```bash
rm .codex/agents/32-employer-defense-eeoc-flsa-discrim.md
# OR
rm .codex/agents/32-employer-defense-eeoc-flsa-discrim.md
```
