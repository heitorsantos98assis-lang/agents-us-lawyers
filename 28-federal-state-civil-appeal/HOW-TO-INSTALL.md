# 28-federal-state-civil-appeal — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `28-federal-state-civil-appeal.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 28-federal-state-civil-appeal.zip
```
...
cp 28-federal-state-civil-appeal.md .claude/agents/
...
```
Use the federal-state-civil-appeal subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 28-federal-state-civil-appeal.md
# OR
...
```bash
rm .claude/agents/28-federal-state-civil-appeal.md
# OR
rm ~/.claude/agents/28-federal-state-civil-appeal.md
```
