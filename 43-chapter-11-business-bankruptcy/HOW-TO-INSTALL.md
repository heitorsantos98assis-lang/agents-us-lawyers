# 43-chapter-11-business-bankruptcy — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `43-chapter-11-business-bankruptcy.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 43-chapter-11-business-bankruptcy.zip
```
...
cp 43-chapter-11-business-bankruptcy.md .claude/agents/
...
```
Use the chapter-11-business-bankruptcy subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 43-chapter-11-business-bankruptcy.md
# OR
...
```bash
rm .claude/agents/43-chapter-11-business-bankruptcy.md
# OR
rm ~/.claude/agents/43-chapter-11-business-bankruptcy.md
```
