# 57-services-msa-sow-independent-contractor — Codex Agent
...
cp 57-services-msa-sow-independent-contractor.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 57-services-msa-sow-independent-contractor.md
# OR
...
```bash
rm .codex/agents/57-services-msa-sow-independent-contractor.md
# OR
rm .codex/agents/57-services-msa-sow-independent-contractor.md
```
