# 40-habeas-corpus-federal-state — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `40-habeas-corpus-federal-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 40-habeas-corpus-federal-state.zip
```
...
cp 40-habeas-corpus-federal-state.md .claude/agents/
...
```
Use the habeas-corpus-federal-state subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 40-habeas-corpus-federal-state.md
# OR
...
```bash
rm .claude/agents/40-habeas-corpus-federal-state.md
# OR
rm ~/.claude/agents/40-habeas-corpus-federal-state.md
```
