# 25-hearing-deposition-trial-prep-calendar — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `25-hearing-deposition-trial-prep-calendar.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 25-hearing-deposition-trial-prep-calendar.zip
```
...
cp 25-hearing-deposition-trial-prep-calendar.md .claude/agents/
...
```
Use the hearing-deposition-trial-prep-calendar subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 25-hearing-deposition-trial-prep-calendar.md
# OR
...
```bash
rm .claude/agents/25-hearing-deposition-trial-prep-calendar.md
# OR
rm ~/.claude/agents/25-hearing-deposition-trial-prep-calendar.md
```
