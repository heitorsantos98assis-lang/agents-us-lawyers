# 14-binding-precedent-mdl-class-cert — Codex Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `14-binding-precedent-mdl-class-cert.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 14-binding-precedent-mdl-class-cert.zip
```
...
cp 14-binding-precedent-mdl-class-cert.md .codex/agents/
...
```
Use the binding-precedent-mdl-class-cert subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 14-binding-precedent-mdl-class-cert.md
# OR
...
```bash
rm .codex/agents/14-binding-precedent-mdl-class-cert.md
# OR
rm .codex/agents/14-binding-precedent-mdl-class-cert.md
```
