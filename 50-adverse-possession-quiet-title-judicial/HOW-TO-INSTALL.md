# 50-adverse-possession-quiet-title-judicial — Codex Agent
...
cp 50-adverse-possession-quiet-title-judicial.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 50-adverse-possession-quiet-title-judicial.md
# OR
...
```bash
rm .codex/agents/50-adverse-possession-quiet-title-judicial.md
# OR
rm .codex/agents/50-adverse-possession-quiet-title-judicial.md
```
