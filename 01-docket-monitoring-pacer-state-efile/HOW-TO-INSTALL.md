# 01-docket-monitoring-pacer-state-efile — Codex Agent
...
cp 01-docket-monitoring-pacer-state-efile.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 01-docket-monitoring-pacer-state-efile.md
# OR
...
```bash
rm .codex/agents/01-docket-monitoring-pacer-state-efile.md
# OR
rm .codex/agents/01-docket-monitoring-pacer-state-efile.md
```
