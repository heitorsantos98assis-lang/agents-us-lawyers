# 36-child-spousal-support-action — Codex Agent
...
cp 36-child-spousal-support-action.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 36-child-spousal-support-action.md
# OR
...
```bash
rm .codex/agents/36-child-spousal-support-action.md
# OR
rm .codex/agents/36-child-spousal-support-action.md
```
