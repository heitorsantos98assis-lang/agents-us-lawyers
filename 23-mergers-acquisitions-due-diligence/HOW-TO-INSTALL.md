# 23-mergers-acquisitions-due-diligence — Codex Agent
...
cp 23-mergers-acquisitions-due-diligence.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 23-mergers-acquisitions-due-diligence.md
# OR
...
```bash
rm .codex/agents/23-mergers-acquisitions-due-diligence.md
# OR
rm .codex/agents/23-mergers-acquisitions-due-diligence.md
```
