...
cp 14-binding-precedent-mdl-class-cert.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 14-binding-precedent-mdl-class-cert.md
# OR
...
```bash
rm .claude/agents/14-binding-precedent-mdl-class-cert.md
# OR
rm ~/.claude/agents/14-binding-precedent-mdl-class-cert.md
```
