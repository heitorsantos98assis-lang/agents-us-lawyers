# 54-judgment-enforcement-collection — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `54-judgment-enforcement-collection.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 54-judgment-enforcement-collection.zip
```
...
cp 54-judgment-enforcement-collection.md .claude/agents/
...
```
Use the judgment-enforcement-collection subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 54-judgment-enforcement-collection.md
# OR
...
```bash
rm .claude/agents/54-judgment-enforcement-collection.md
# OR
rm ~/.claude/agents/54-judgment-enforcement-collection.md
```
