# 08-appellate-strategy-and-brief — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `08-appellate-strategy-and-brief.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 08-appellate-strategy-and-brief.zip
```
...
cp 08-appellate-strategy-and-brief.md .claude/agents/
...
```
Use the appellate-strategy-and-brief subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 08-appellate-strategy-and-brief.md
# OR
...
```bash
rm .claude/agents/08-appellate-strategy-and-brief.md
# OR
rm ~/.claude/agents/08-appellate-strategy-and-brief.md
```
