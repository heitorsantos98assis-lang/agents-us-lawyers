# 07-answer-and-affirmative-defenses — Codex Agent
...
cp 07-answer-and-affirmative-defenses.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 07-answer-and-affirmative-defenses.md
# OR
...
```bash
rm .codex/agents/07-answer-and-affirmative-defenses.md
# OR
rm .codex/agents/07-answer-and-affirmative-defenses.md
```
