# 42-tax-collection-defense-cdp — Codex Agent
...
cp 42-tax-collection-defense-cdp.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 42-tax-collection-defense-cdp.md
# OR
...
```bash
rm .codex/agents/42-tax-collection-defense-cdp.md
# OR
rm .codex/agents/42-tax-collection-defense-cdp.md
```
