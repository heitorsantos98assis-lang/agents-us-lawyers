# 31-employment-plaintiff-complaint-eeoc — Codex Agent
...
cp 31-employment-plaintiff-complaint-eeoc.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 31-employment-plaintiff-complaint-eeoc.md
# OR
...
```bash
rm .codex/agents/31-employment-plaintiff-complaint-eeoc.md
# OR
rm .codex/agents/31-employment-plaintiff-complaint-eeoc.md
```
