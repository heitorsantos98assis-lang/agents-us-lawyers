# 56-judgment-prejudgment-interest-calculation — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `56-judgment-prejudgment-interest-calculation.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 56-judgment-prejudgment-interest-calculation.zip
```
...
cp 56-judgment-prejudgment-interest-calculation.md .claude/agents/
...
```
Use the judgment-prejudgment-interest-calculation subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 56-judgment-prejudgment-interest-calculation.md
# OR
...
```bash
rm .claude/agents/56-judgment-prejudgment-interest-calculation.md
# OR
rm ~/.claude/agents/56-judgment-prejudgment-interest-calculation.md
```
