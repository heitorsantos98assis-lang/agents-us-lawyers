# 12-treatises-restatements-secondary — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `12-treatises-restatements-secondary.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 12-treatises-restatements-secondary.zip
```
...
cp 12-treatises-restatements-secondary.md .claude/agents/
...
```
Use the treatises-restatements-secondary subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 12-treatises-restatements-secondary.md
# OR
...
```bash
rm .claude/agents/12-treatises-restatements-secondary.md
# OR
rm ~/.claude/agents/12-treatises-restatements-secondary.md
```
