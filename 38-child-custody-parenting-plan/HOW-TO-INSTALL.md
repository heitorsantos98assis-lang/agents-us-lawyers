# 38-child-custody-parenting-plan — Codex Agent
...
cp 38-child-custody-parenting-plan.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 38-child-custody-parenting-plan.md
# OR
...
```bash
rm .codex/agents/38-child-custody-parenting-plan.md
# OR
rm .codex/agents/38-child-custody-parenting-plan.md
```
