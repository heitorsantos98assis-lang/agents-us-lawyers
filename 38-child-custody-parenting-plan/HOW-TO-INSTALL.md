# 38-child-custody-parenting-plan — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `38-child-custody-parenting-plan.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 38-child-custody-parenting-plan.zip
```
...
cp 38-child-custody-parenting-plan.md .claude/agents/
...
```
Use the child-custody-parenting-plan subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 38-child-custody-parenting-plan.md
# OR
...
```bash
rm .claude/agents/38-child-custody-parenting-plan.md
# OR
rm ~/.claude/agents/38-child-custody-parenting-plan.md
```
