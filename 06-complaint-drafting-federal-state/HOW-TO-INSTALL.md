# 06-complaint-drafting-federal-state — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `06-complaint-drafting-federal-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 06-complaint-drafting-federal-state.zip
```
...
cp 06-complaint-drafting-federal-state.md .claude/agents/
...
```
Use the complaint-drafting-federal-state subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 06-complaint-drafting-federal-state.md
# OR
...
```bash
rm .claude/agents/06-complaint-drafting-federal-state.md
# OR
rm ~/.claude/agents/06-complaint-drafting-federal-state.md
```
