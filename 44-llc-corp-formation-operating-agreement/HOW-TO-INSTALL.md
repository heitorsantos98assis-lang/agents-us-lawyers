# 44-llc-corp-formation-operating-agreement — Codex Agent
...
cp 44-llc-corp-formation-operating-agreement.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 44-llc-corp-formation-operating-agreement.md
# OR
...
```bash
rm .codex/agents/44-llc-corp-formation-operating-agreement.md
# OR
rm .codex/agents/44-llc-corp-formation-operating-agreement.md
```
