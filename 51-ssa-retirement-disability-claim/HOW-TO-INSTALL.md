# 51-ssa-retirement-disability-claim — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `51-ssa-retirement-disability-claim.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 51-ssa-retirement-disability-claim.zip
```
...
cp 51-ssa-retirement-disability-claim.md .claude/agents/
...
```
Use the ssa-retirement-disability-claim subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 51-ssa-retirement-disability-claim.md
# OR
...
```bash
rm .claude/agents/51-ssa-retirement-disability-claim.md
# OR
rm ~/.claude/agents/51-ssa-retirement-disability-claim.md
```
