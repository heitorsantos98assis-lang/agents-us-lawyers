# 13-statutes-and-regulations-research — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `13-statutes-and-regulations-research.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 13-statutes-and-regulations-research.zip
```
...
cp 13-statutes-and-regulations-research.md .claude/agents/
...
```
Use the statutes-and-regulations-research subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 13-statutes-and-regulations-research.md
# OR
...
```bash
rm .claude/agents/13-statutes-and-regulations-research.md
# OR
rm ~/.claude/agents/13-statutes-and-regulations-research.md
```
