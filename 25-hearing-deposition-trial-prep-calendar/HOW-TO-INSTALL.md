# 25-hearing-deposition-trial-prep-calendar — Codex Agent
...
cp 25-hearing-deposition-trial-prep-calendar.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 25-hearing-deposition-trial-prep-calendar.md
# OR
...
```bash
rm .codex/agents/25-hearing-deposition-trial-prep-calendar.md
# OR
rm .codex/agents/25-hearing-deposition-trial-prep-calendar.md
```
