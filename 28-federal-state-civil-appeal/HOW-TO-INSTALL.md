# 28-federal-state-civil-appeal — Codex Agent
...
cp 28-federal-state-civil-appeal.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 28-federal-state-civil-appeal.md
# OR
...
```bash
rm .codex/agents/28-federal-state-civil-appeal.md
# OR
rm .codex/agents/28-federal-state-civil-appeal.md
```
