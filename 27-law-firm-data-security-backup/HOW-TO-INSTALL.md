...
cp 27-law-firm-data-security-backup.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 27-law-firm-data-security-backup.md
# OR
...
```bash
rm .claude/agents/27-law-firm-data-security-backup.md
# OR
rm ~/.claude/agents/27-law-firm-data-security-backup.md
```
