# 12-treatises-restatements-secondary — Codex Agent
...
cp 12-treatises-restatements-secondary.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 12-treatises-restatements-secondary.md
# OR
...
```bash
rm .codex/agents/12-treatises-restatements-secondary.md
# OR
rm .codex/agents/12-treatises-restatements-secondary.md
```
