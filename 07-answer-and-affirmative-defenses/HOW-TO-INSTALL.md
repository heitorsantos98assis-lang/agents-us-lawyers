# 07-answer-and-affirmative-defenses — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `07-answer-and-affirmative-defenses.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 07-answer-and-affirmative-defenses.zip
```
...
cp 07-answer-and-affirmative-defenses.md .claude/agents/
...
```
Use the answer-and-affirmative-defenses subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 07-answer-and-affirmative-defenses.md
# OR
...
```bash
rm .claude/agents/07-answer-and-affirmative-defenses.md
# OR
rm ~/.claude/agents/07-answer-and-affirmative-defenses.md
```
