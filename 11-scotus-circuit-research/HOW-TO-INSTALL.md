# 11-scotus-circuit-research — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `11-scotus-circuit-research.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 11-scotus-circuit-research.zip
```
...
cp 11-scotus-circuit-research.md .claude/agents/
...
```
Use the scotus-circuit-research subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 11-scotus-circuit-research.md
# OR
...
```bash
rm .claude/agents/11-scotus-circuit-research.md
# OR
rm ~/.claude/agents/11-scotus-circuit-research.md
```
