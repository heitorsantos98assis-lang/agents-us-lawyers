# 48-commercial-lease-renewal-option — Codex Agent
...
cp 48-commercial-lease-renewal-option.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 48-commercial-lease-renewal-option.md
# OR
...
```bash
rm .codex/agents/48-commercial-lease-renewal-option.md
# OR
rm .codex/agents/48-commercial-lease-renewal-option.md
```
