# 10-engagement-letter-and-notice-of-appearance — Codex Agent
...
cp 10-engagement-letter-and-notice-of-appearance.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 10-engagement-letter-and-notice-of-appearance.md
# OR
...
```bash
rm .codex/agents/10-engagement-letter-and-notice-of-appearance.md
# OR
rm .codex/agents/10-engagement-letter-and-notice-of-appearance.md
```
