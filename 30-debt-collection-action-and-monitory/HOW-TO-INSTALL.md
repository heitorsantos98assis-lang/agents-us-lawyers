# 30-debt-collection-action-and-monitory — Codex Agent
...
cp 30-debt-collection-action-and-monitory.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 30-debt-collection-action-and-monitory.md
# OR
...
```bash
rm .codex/agents/30-debt-collection-action-and-monitory.md
# OR
rm .codex/agents/30-debt-collection-action-and-monitory.md
```
