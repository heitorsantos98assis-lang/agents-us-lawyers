# 02-deadline-calendaring-frcp-state — Codex Agent
...
cp 02-deadline-calendaring-frcp-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 02-deadline-calendaring-frcp-state.md
# OR
...
```bash
rm .codex/agents/02-deadline-calendaring-frcp-state.md
# OR
rm .codex/agents/02-deadline-calendaring-frcp-state.md
```
