...
cp 41-tax-controversy-irs-state.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 41-tax-controversy-irs-state.md
# OR
...
```bash
rm .claude/agents/41-tax-controversy-irs-state.md
# OR
rm ~/.claude/agents/41-tax-controversy-irs-state.md
```
