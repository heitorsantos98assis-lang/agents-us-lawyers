# 06-complaint-drafting-federal-state — Codex Agent
...
cp 06-complaint-drafting-federal-state.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 06-complaint-drafting-federal-state.md
# OR
...
```bash
rm .codex/agents/06-complaint-drafting-federal-state.md
# OR
rm .codex/agents/06-complaint-drafting-federal-state.md
```
