# 17-initial-client-counseling — Codex Agent
...
cp 17-initial-client-counseling.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 17-initial-client-counseling.md
# OR
...
```bash
rm .codex/agents/17-initial-client-counseling.md
# OR
rm .codex/agents/17-initial-client-counseling.md
```
