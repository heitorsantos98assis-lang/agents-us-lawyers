# 18-client-onboarding-engagement-iolta — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `18-client-onboarding-engagement-iolta.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 18-client-onboarding-engagement-iolta.zip
```
...
cp 18-client-onboarding-engagement-iolta.md .claude/agents/
...
```
Use the client-onboarding-engagement-iolta subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 18-client-onboarding-engagement-iolta.md
# OR
...
```bash
rm .claude/agents/18-client-onboarding-engagement-iolta.md
# OR
rm ~/.claude/agents/18-client-onboarding-engagement-iolta.md
```
