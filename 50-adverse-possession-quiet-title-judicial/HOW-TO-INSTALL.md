# 50-adverse-possession-quiet-title-judicial — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `50-adverse-possession-quiet-title-judicial.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 50-adverse-possession-quiet-title-judicial.zip
```
...
cp 50-adverse-possession-quiet-title-judicial.md .claude/agents/
...
```
Use the adverse-possession-quiet-title-judicial subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 50-adverse-possession-quiet-title-judicial.md
# OR
...
```bash
rm .claude/agents/50-adverse-possession-quiet-title-judicial.md
# OR
rm ~/.claude/agents/50-adverse-possession-quiet-title-judicial.md
```
