# 16-new-client-matter-intake — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `16-new-client-matter-intake.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 16-new-client-matter-intake.zip
```
...
cp 16-new-client-matter-intake.md .claude/agents/
...
```
Use the new-client-matter-intake subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 16-new-client-matter-intake.md
# OR
...
```bash
rm .claude/agents/16-new-client-matter-intake.md
# OR
rm ~/.claude/agents/16-new-client-matter-intake.md
```
