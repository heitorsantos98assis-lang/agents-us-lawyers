# 47-eviction-unlawful-detainer — Codex Agent
...
cp 47-eviction-unlawful-detainer.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 47-eviction-unlawful-detainer.md
# OR
...
```bash
rm .codex/agents/47-eviction-unlawful-detainer.md
# OR
rm .codex/agents/47-eviction-unlawful-detainer.md
```
