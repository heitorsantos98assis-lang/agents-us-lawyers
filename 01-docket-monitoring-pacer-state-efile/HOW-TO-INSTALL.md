# 01-docket-monitoring-pacer-state-efile — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `01-docket-monitoring-pacer-state-efile.md` for the full description, frameworks, reference tables, and operating flow.
...
cp 01-docket-monitoring-pacer-state-efile.md .claude/agents/
...
```bash
ls .claude/agents/   # should list 01-docket-monitoring-pacer-state-efile.md
# OR
...
```bash
rm .claude/agents/01-docket-monitoring-pacer-state-efile.md
# OR
rm ~/.claude/agents/01-docket-monitoring-pacer-state-efile.md
```
