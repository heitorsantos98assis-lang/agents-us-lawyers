# 56-judgment-prejudgment-interest-calculation — Codex Agent
...
cp 56-judgment-prejudgment-interest-calculation.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 56-judgment-prejudgment-interest-calculation.md
# OR
...
```bash
rm .codex/agents/56-judgment-prejudgment-interest-calculation.md
# OR
rm .codex/agents/56-judgment-prejudgment-interest-calculation.md
```
