# 15-case-headnote-knowledge-bank — Codex Agent
...
cp 15-case-headnote-knowledge-bank.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 15-case-headnote-knowledge-bank.md
# OR
...
```bash
rm .codex/agents/15-case-headnote-knowledge-bank.md
# OR
rm .codex/agents/15-case-headnote-knowledge-bank.md
```
