# 10-engagement-letter-and-notice-of-appearance — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `10-engagement-letter-and-notice-of-appearance.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 10-engagement-letter-and-notice-of-appearance.zip
```
...
cp 10-engagement-letter-and-notice-of-appearance.md .claude/agents/
...
```
Use the engagement-letter-and-notice-of-appearance subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 10-engagement-letter-and-notice-of-appearance.md
# OR
...
```bash
rm .claude/agents/10-engagement-letter-and-notice-of-appearance.md
# OR
rm ~/.claude/agents/10-engagement-letter-and-notice-of-appearance.md
```
