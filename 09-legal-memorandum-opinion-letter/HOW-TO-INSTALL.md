# 09-legal-memorandum-opinion-letter — Codex Agent
...
cp 09-legal-memorandum-opinion-letter.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 09-legal-memorandum-opinion-letter.md
# OR
...
```bash
rm .codex/agents/09-legal-memorandum-opinion-letter.md
# OR
rm .codex/agents/09-legal-memorandum-opinion-letter.md
```
