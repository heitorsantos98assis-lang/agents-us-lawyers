# 37-probate-non-judicial-and-small-estate — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `37-probate-non-judicial-and-small-estate.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 37-probate-non-judicial-and-small-estate.zip
```
...
cp 37-probate-non-judicial-and-small-estate.md .claude/agents/
...
```
Use the probate-non-judicial-and-small-estate subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 37-probate-non-judicial-and-small-estate.md
# OR
...
```bash
rm .claude/agents/37-probate-non-judicial-and-small-estate.md
# OR
rm ~/.claude/agents/37-probate-non-judicial-and-small-estate.md
```
