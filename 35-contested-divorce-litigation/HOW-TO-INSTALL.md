# 35-contested-divorce-litigation — Codex Agent
...
cp 35-contested-divorce-litigation.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 35-contested-divorce-litigation.md
# OR
...
```bash
rm .codex/agents/35-contested-divorce-litigation.md
# OR
rm .codex/agents/35-contested-divorce-litigation.md
```
