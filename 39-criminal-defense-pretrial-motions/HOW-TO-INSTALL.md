# 39-criminal-defense-pretrial-motions — Codex Agent
...
cp 39-criminal-defense-pretrial-motions.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 39-criminal-defense-pretrial-motions.md
# OR
...
```bash
rm .codex/agents/39-criminal-defense-pretrial-motions.md
# OR
rm .codex/agents/39-criminal-defense-pretrial-motions.md
```
