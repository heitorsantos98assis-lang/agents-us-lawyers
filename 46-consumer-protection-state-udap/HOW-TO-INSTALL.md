# 46-consumer-protection-state-udap — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `46-consumer-protection-state-udap.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 46-consumer-protection-state-udap.zip
```
...
cp 46-consumer-protection-state-udap.md .claude/agents/
...
```
Use the consumer-protection-state-udap subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 46-consumer-protection-state-udap.md
# OR
...
```bash
rm .claude/agents/46-consumer-protection-state-udap.md
# OR
rm ~/.claude/agents/46-consumer-protection-state-udap.md
```
