# 41-tax-controversy-irs-state — Codex Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `41-tax-controversy-irs-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 41-tax-controversy-irs-state.zip
```
...
cp 41-tax-controversy-irs-state.md .codex/agents/
...
```
Use the tax-controversy-irs-state subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 41-tax-controversy-irs-state.md
# OR
...
```bash
rm .codex/agents/41-tax-controversy-irs-state.md
# OR
rm .codex/agents/41-tax-controversy-irs-state.md
```
