# 22-privacy-data-protection-us-state — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `22-privacy-data-protection-us-state.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 22-privacy-data-protection-us-state.zip
```
...
cp 22-privacy-data-protection-us-state.md .claude/agents/
...
```
Use the privacy-data-protection-us-state subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 22-privacy-data-protection-us-state.md
# OR
...
```bash
rm .claude/agents/22-privacy-data-protection-us-state.md
# OR
rm ~/.claude/agents/22-privacy-data-protection-us-state.md
```
