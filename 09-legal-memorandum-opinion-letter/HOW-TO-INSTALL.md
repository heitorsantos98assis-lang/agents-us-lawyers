# 09-legal-memorandum-opinion-letter — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `09-legal-memorandum-opinion-letter.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 09-legal-memorandum-opinion-letter.zip
```
...
cp 09-legal-memorandum-opinion-letter.md .claude/agents/
...
```
Use the legal-memorandum-opinion-letter subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 09-legal-memorandum-opinion-letter.md
# OR
...
```bash
rm .claude/agents/09-legal-memorandum-opinion-letter.md
# OR
rm ~/.claude/agents/09-legal-memorandum-opinion-letter.md
```
