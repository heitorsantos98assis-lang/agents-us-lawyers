# 52-ssi-medicaid-needs-based-benefit — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `52-ssi-medicaid-needs-based-benefit.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 52-ssi-medicaid-needs-based-benefit.zip
```
...
cp 52-ssi-medicaid-needs-based-benefit.md .claude/agents/
...
```
Use the ssi-medicaid-needs-based-benefit subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 52-ssi-medicaid-needs-based-benefit.md
# OR
...
```bash
rm .claude/agents/52-ssi-medicaid-needs-based-benefit.md
# OR
rm ~/.claude/agents/52-ssi-medicaid-needs-based-benefit.md
```
