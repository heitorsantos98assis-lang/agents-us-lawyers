# 37-probate-non-judicial-and-small-estate — Codex Agent
...
cp 37-probate-non-judicial-and-small-estate.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 37-probate-non-judicial-and-small-estate.md
# OR
...
```bash
rm .codex/agents/37-probate-non-judicial-and-small-estate.md
# OR
rm .codex/agents/37-probate-non-judicial-and-small-estate.md
```
