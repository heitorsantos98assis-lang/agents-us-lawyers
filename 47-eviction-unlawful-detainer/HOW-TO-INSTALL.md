# 47-eviction-unlawful-detainer — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `47-eviction-unlawful-detainer.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 47-eviction-unlawful-detainer.zip
```
...
cp 47-eviction-unlawful-detainer.md .claude/agents/
...
```
Use the eviction-unlawful-detainer subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 47-eviction-unlawful-detainer.md
# OR
...
```bash
rm .claude/agents/47-eviction-unlawful-detainer.md
# OR
rm ~/.claude/agents/47-eviction-unlawful-detainer.md
```
