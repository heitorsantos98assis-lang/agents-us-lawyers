# 29-interlocutory-appeal-writ-mandamus — Codex Agent
...
cp 29-interlocutory-appeal-writ-mandamus.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 29-interlocutory-appeal-writ-mandamus.md
# OR
...
```bash
rm .codex/agents/29-interlocutory-appeal-writ-mandamus.md
# OR
rm .codex/agents/29-interlocutory-appeal-writ-mandamus.md
```
