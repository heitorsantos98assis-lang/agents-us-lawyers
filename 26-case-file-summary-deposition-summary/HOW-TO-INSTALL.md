# 26-case-file-summary-deposition-summary — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `26-case-file-summary-deposition-summary.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 26-case-file-summary-deposition-summary.zip
```
...
cp 26-case-file-summary-deposition-summary.md .claude/agents/
...
```
Use the case-file-summary-deposition-summary subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 26-case-file-summary-deposition-summary.md
# OR
...
```bash
rm .claude/agents/26-case-file-summary-deposition-summary.md
# OR
rm ~/.claude/agents/26-case-file-summary-deposition-summary.md
```
