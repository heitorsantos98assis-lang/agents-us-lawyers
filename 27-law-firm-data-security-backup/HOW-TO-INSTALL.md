# 27-law-firm-data-security-backup — Codex Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `27-law-firm-data-security-backup.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 27-law-firm-data-security-backup.zip
```
...
cp 27-law-firm-data-security-backup.md .codex/agents/
...
```
Use the law-firm-data-security-backup subagent to ...
```

## Verifying installation

```bash
ls .codex/agents/   # should list 27-law-firm-data-security-backup.md
# OR
...
```bash
rm .codex/agents/27-law-firm-data-security-backup.md
# OR
rm .codex/agents/27-law-firm-data-security-backup.md
```
