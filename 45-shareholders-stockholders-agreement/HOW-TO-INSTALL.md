# 45-shareholders-stockholders-agreement — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `45-shareholders-stockholders-agreement.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 45-shareholders-stockholders-agreement.zip
```
...
cp 45-shareholders-stockholders-agreement.md .claude/agents/
...
```
Use the shareholders-stockholders-agreement subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 45-shareholders-stockholders-agreement.md
# OR
...
```bash
rm .claude/agents/45-shareholders-stockholders-agreement.md
# OR
rm ~/.claude/agents/45-shareholders-stockholders-agreement.md
```
