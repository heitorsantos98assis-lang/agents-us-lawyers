# 45-shareholders-stockholders-agreement — Codex Agent
...
cp 45-shareholders-stockholders-agreement.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 45-shareholders-stockholders-agreement.md
# OR
...
```bash
rm .codex/agents/45-shareholders-stockholders-agreement.md
# OR
rm .codex/agents/45-shareholders-stockholders-agreement.md
```
