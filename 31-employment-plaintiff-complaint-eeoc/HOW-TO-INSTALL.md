# 31-employment-plaintiff-complaint-eeoc — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `31-employment-plaintiff-complaint-eeoc.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 31-employment-plaintiff-complaint-eeoc.zip
```
...
cp 31-employment-plaintiff-complaint-eeoc.md .claude/agents/
...
```
Use the employment-plaintiff-complaint-eeoc subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 31-employment-plaintiff-complaint-eeoc.md
# OR
...
```bash
rm .claude/agents/31-employment-plaintiff-complaint-eeoc.md
# OR
rm ~/.claude/agents/31-employment-plaintiff-complaint-eeoc.md
```
