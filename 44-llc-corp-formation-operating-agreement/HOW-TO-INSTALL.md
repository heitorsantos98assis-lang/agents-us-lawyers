# 44-llc-corp-formation-operating-agreement — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `44-llc-corp-formation-operating-agreement.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 44-llc-corp-formation-operating-agreement.zip
```
...
cp 44-llc-corp-formation-operating-agreement.md .claude/agents/
...
```
Use the llc-corp-formation-operating-agreement subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 44-llc-corp-formation-operating-agreement.md
# OR
...
```bash
rm .claude/agents/44-llc-corp-formation-operating-agreement.md
# OR
rm ~/.claude/agents/44-llc-corp-formation-operating-agreement.md
```
