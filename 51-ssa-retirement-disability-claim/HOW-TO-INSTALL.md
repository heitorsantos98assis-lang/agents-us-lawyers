# 51-ssa-retirement-disability-claim — Codex Agent
...
cp 51-ssa-retirement-disability-claim.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 51-ssa-retirement-disability-claim.md
# OR
...
```bash
rm .codex/agents/51-ssa-retirement-disability-claim.md
# OR
rm .codex/agents/51-ssa-retirement-disability-claim.md
```
