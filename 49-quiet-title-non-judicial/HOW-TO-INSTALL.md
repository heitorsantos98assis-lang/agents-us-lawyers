# 49-quiet-title-non-judicial — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `49-quiet-title-non-judicial.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 49-quiet-title-non-judicial.zip
```
...
cp 49-quiet-title-non-judicial.md .claude/agents/
...
```
Use the quiet-title-non-judicial subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 49-quiet-title-non-judicial.md
# OR
...
```bash
rm .claude/agents/49-quiet-title-non-judicial.md
# OR
rm ~/.claude/agents/49-quiet-title-non-judicial.md
```
