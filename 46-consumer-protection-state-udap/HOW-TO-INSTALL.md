# 46-consumer-protection-state-udap — Codex Agent
...
cp 46-consumer-protection-state-udap.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 46-consumer-protection-state-udap.md
# OR
...
```bash
rm .codex/agents/46-consumer-protection-state-udap.md
# OR
rm .codex/agents/46-consumer-protection-state-udap.md
```
