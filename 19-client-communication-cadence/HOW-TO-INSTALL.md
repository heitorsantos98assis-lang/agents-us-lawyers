# 19-client-communication-cadence — Codex Agent
...
cp 19-client-communication-cadence.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 19-client-communication-cadence.md
# OR
...
```bash
rm .codex/agents/19-client-communication-cadence.md
# OR
rm .codex/agents/19-client-communication-cadence.md
```
