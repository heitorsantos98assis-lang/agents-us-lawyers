# 05-notice-of-receipt-acknowledgment — Codex Agent
...
cp 05-notice-of-receipt-acknowledgment.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 05-notice-of-receipt-acknowledgment.md
# OR
...
```bash
rm .codex/agents/05-notice-of-receipt-acknowledgment.md
# OR
rm .codex/agents/05-notice-of-receipt-acknowledgment.md
```
