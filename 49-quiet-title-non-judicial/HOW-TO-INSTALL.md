# 49-quiet-title-non-judicial — Codex Agent
...
cp 49-quiet-title-non-judicial.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 49-quiet-title-non-judicial.md
# OR
...
```bash
rm .codex/agents/49-quiet-title-non-judicial.md
# OR
rm .codex/agents/49-quiet-title-non-judicial.md
```
