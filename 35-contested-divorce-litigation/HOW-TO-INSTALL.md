# 35-contested-divorce-litigation — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `35-contested-divorce-litigation.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 35-contested-divorce-litigation.zip
```
...
cp 35-contested-divorce-litigation.md .claude/agents/
...
```
Use the contested-divorce-litigation subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 35-contested-divorce-litigation.md
# OR
...
```bash
rm .claude/agents/35-contested-divorce-litigation.md
# OR
rm ~/.claude/agents/35-contested-divorce-litigation.md
```
