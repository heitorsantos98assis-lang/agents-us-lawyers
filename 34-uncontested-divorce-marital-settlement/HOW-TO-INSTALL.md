# 34-uncontested-divorce-marital-settlement — Codex Agent
...
cp 34-uncontested-divorce-marital-settlement.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 34-uncontested-divorce-marital-settlement.md
# OR
...
```bash
rm .codex/agents/34-uncontested-divorce-marital-settlement.md
# OR
rm .codex/agents/34-uncontested-divorce-marital-settlement.md
```
