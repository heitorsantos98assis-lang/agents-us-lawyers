# 39-criminal-defense-pretrial-motions — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `39-criminal-defense-pretrial-motions.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 39-criminal-defense-pretrial-motions.zip
```
...
cp 39-criminal-defense-pretrial-motions.md .claude/agents/
...
```
Use the criminal-defense-pretrial-motions subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 39-criminal-defense-pretrial-motions.md
# OR
...
```bash
rm .claude/agents/39-criminal-defense-pretrial-motions.md
# OR
rm ~/.claude/agents/39-criminal-defense-pretrial-motions.md
```
