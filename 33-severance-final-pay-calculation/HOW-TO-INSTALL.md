# 33-severance-final-pay-calculation — Codex Agent
...
cp 33-severance-final-pay-calculation.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 33-severance-final-pay-calculation.md
# OR
...
```bash
rm .codex/agents/33-severance-final-pay-calculation.md
# OR
rm .codex/agents/33-severance-final-pay-calculation.md
```
