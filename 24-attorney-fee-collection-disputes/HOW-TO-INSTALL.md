# 24-attorney-fee-collection-disputes — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (Bravy / ASV Digital).

## What this agent does

See `24-attorney-fee-collection-disputes.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 24-attorney-fee-collection-disputes.zip
```
...
cp 24-attorney-fee-collection-disputes.md .claude/agents/
...
```
Use the attorney-fee-collection-disputes subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 24-attorney-fee-collection-disputes.md
# OR
...
```bash
rm .claude/agents/24-attorney-fee-collection-disputes.md
# OR
rm ~/.claude/agents/24-attorney-fee-collection-disputes.md
```
