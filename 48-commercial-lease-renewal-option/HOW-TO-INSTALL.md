# 48-commercial-lease-renewal-option — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `48-commercial-lease-renewal-option.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 48-commercial-lease-renewal-option.zip
```
...
cp 48-commercial-lease-renewal-option.md .claude/agents/
...
```
Use the commercial-lease-renewal-option subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 48-commercial-lease-renewal-option.md
# OR
...
```bash
rm .claude/agents/48-commercial-lease-renewal-option.md
# OR
rm ~/.claude/agents/48-commercial-lease-renewal-option.md
```
