# 24-attorney-fee-collection-disputes — Codex Agent
...
cp 24-attorney-fee-collection-disputes.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 24-attorney-fee-collection-disputes.md
# OR
...
```bash
rm .codex/agents/24-attorney-fee-collection-disputes.md
# OR
rm .codex/agents/24-attorney-fee-collection-disputes.md
```
