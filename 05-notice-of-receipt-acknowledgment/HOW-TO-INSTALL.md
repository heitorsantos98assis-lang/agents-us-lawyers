# 05-notice-of-receipt-acknowledgment — Claude Code Agent

A specialist subagent from the **57 Agents for US Lawyers** bundle (HL).

## What this agent does

See `05-notice-of-receipt-acknowledgment.md` for the full description, frameworks, reference tables, and operating flow.
...
```bash
unzip 05-notice-of-receipt-acknowledgment.zip
```
...
cp 05-notice-of-receipt-acknowledgment.md .claude/agents/
...
```
Use the notice-of-receipt-acknowledgment subagent to ...
```

## Verifying installation

```bash
ls .claude/agents/   # should list 05-notice-of-receipt-acknowledgment.md
# OR
...
```bash
rm .claude/agents/05-notice-of-receipt-acknowledgment.md
# OR
rm ~/.claude/agents/05-notice-of-receipt-acknowledgment.md
```
