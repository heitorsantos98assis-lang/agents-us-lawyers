# 26-case-file-summary-deposition-summary — Codex Agent
...
cp 26-case-file-summary-deposition-summary.md .codex/agents/
...
```bash
ls .codex/agents/   # should list 26-case-file-summary-deposition-summary.md
# OR
...
```bash
rm .codex/agents/26-case-file-summary-deposition-summary.md
# OR
rm .codex/agents/26-case-file-summary-deposition-summary.md
```
